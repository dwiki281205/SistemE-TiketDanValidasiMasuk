...
<div class="max-w-md mx-auto" style="max-width: 600px; margin-top: 40px;">
    <div class="card shadow border-0 overflow-hidden">
        <div class="card-header bg-dark text-white p-4 text-center position-relative" style="background-color: #0f172a !important;">
            <div class="position-absolute" style="width: 150px; height: 150px; background: rgba(99, 102, 241, 0.15); filter: blur(40px); border-radius: 50%; top: -30px; left: -30px;"></div>
            ...
            <form method="POST" action="/check-ticket">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        <span class="input-group-text border-end-0 bg-white" style="border-radius: 12px 0 0 12px; border: 1.5px solid #e2e8f0; border-right: none !important;"><span class="fs-5">🎫</span></span>
                ...
                <button type="submit" class="btn btn-primary w-100 py-3 d-flex align-items-center justify-content-center gap-2">
                    <span>⚡</span> Jalankan Validasi
                </button>
            </form>
        </div>

        <div class="card-footer bg-light p-4 border-top text-center text-muted small">
            <span>💡</span> <strong>Informasi:</strong> Tiket yang valid akan secara otomatis ditandai sebagai "Sudah Digunakan" setelah proses validasi ini selesai.
        </div>
    </div>
</div>
