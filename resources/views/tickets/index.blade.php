                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($ticket->refund_status == 'pending')
                                <span class="badge-pill-custom status-pending">Pending</span>
                            @elseif($ticket->refund_status == 'rejected')
                                <span class="badge-pill-custom status-rejected">Rejected</span>
                            @else
                                <span class="badge-pill-custom status-approved">Paid</span>
                            @endif
                        </td>
                        <td>
